...
> Generated at: 2025-12-23T18:37:28.975Z
...
- **FOREIGN KEY**: `email_verifications_user_id_fkey`
...
| 18 | `account_type` | `text` | YES | 'individual'::text |  |
...
- **CHECK**: `users_account_type_check`, `users_created_at_not_null`, `users_email_not_null`, `users_id_not_null`, `users_name_not_null`, `users_password_hash_not_null`, `users_roles_not_null`, `users_updated_at_not_null`
